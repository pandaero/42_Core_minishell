// Tests for the functions in utils/utils_expansion_3.c
#include "../minishell.h"
#include <stdio.h>
#include <stdlib.h>

//*Test for string_expansion. cc -Wall -Werror -Wextra test/utils_expansion_3_main.c src/utils/utils_expansion_3.c src/utils/utils_expansion_2.c src/utils/utils_expansion.c src/builtin/builtin_echo.c src/utils/utils.c src/utils/utils_2.c src/utils/utils_env_4.c src/utils/utils_env_3.c src/utils/utils_env_2.c src/utils/utils_env.c src/main/init.c src/memory/memory.c libft/libft.a
int	main(int argc, char **argv, char **env)
{
	...
	printf("%s\n", new2);
	char	*str3 = ft_strdup("\"hello\'t\"h\'\'ere\"again\"");
	printf("%s\n", str3);
