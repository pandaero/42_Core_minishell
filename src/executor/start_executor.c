...
/*   Updated: 2022/12/02 17:09:28 by zyunusov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_fork(t_minidata *minidata, int end[2],int fd_in, t_simple_cmds *cmd)
{
    static int  i = 0;
...
int start_executor(t_minidata *minidata)
{
    ...
    while (minidata->simple_cmds)
    {
        ...
        ft_fork(minidata, end, fd_in, minidata->simple_cmds);
    }
}